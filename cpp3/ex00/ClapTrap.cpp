...
/*   Updated: 2025/05/09 03:04:22 by throbert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (this->energy_point > 0 && (this->hit_points + amount) < 10)
	{
		...
		std::cout << "/!\\ ClapTrap " << this->name << " cannot be repaired because he already is fully alive (10 hit points) /!\\" << std::endl << std::endl;
	else
	{
